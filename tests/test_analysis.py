...
_SUMMARY_ROWS = [
    ...
    },
    {
        ...
        "ciphertext_size_bytes": "2420",
        "shared_secret_size_bytes": "0",
...
class TestLoadSummaryCSV:
    def test_returns_list_of_dicts(self, tmp_path):
        ...
        assert len(rows) == 2
        assert rows[0]["algorithm"] == "FIPS-203-ML-KEM-512"
...
class TestCompareAlgorithms:
    def test_sorted_ascending(self):
        ...
        assert ranked[0]["algorithm"] == "Dilithium-ML-DSA-44"  # 0.0005 < 0.001
